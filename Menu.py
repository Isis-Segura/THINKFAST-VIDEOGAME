...
try:
    ...
    while intro_running and vid.active:
        for event in pygame.event.get():
            ...
            # Permite saltar el video con cualquier tecla o clic
        ...
        if intro_running and vid.active:
            # Dibuja el frame actual del video en la pantalla
            vid.draw(screen, (0, 0)) 
    ...
    # El objeto de video se cierra automáticamente o al saltar.
    vid.close() 

except FileNotFoundError:
    print(f"Advertencia: Archivo de video no encontrado en '{intro_path}'. Iniciando en el menú.")
except AttributeError as e:
    # Esto atraparía errores si 'draw' o 'active' no existen en la versión instalada.
    print(f"Advertencia: Error de atributo en la reproducción del video ({e}). Iniciando en el menú.")
except Exception as e:
    print(f"Error desconocido al reproducir el video: {e}. Iniciando en el menú.")
...
def draw_config_menu(back_button_rect):
    ...
    flag_button_width, flag_button_height = 120, 70  # Tamaño más pequeño para banderas
    flag_spacing = 30  # Espacio entre banderas
    
    global language_es_rect, language_en_rect
    
    # Botón Bandera mexico
