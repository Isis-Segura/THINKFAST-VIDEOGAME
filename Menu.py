...
# Fuentes
# Fuentes con distintos tamaños
font_large = pygame.font.Font("Materials/Fonts/PressStart2P-Regular.ttf", 25)  # Titulos grandes
font_medium = pygame.font.Font("Materials/Fonts/PressStart2P-Regular.ttf", 20) # Botones
font_small = pygame.font.Font("Materials/Fonts/PressStart2P-Regular.ttf", 10)  # Textos largos
